...
class RefreshDbUseCase @Inject constructor(
    private val repository: EQRepository,
    @ApplicationContext private val context: Context
) {
    private val TAG = "RefreshDbUseCase"

    suspend operator fun invoke(feed: EQFeaturesCollectionDTO): DbResponse<SaveResult> {
        return try {

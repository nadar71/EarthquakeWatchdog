...
class EarthquakeNetworkDataSource private constructor(
    ...
    private val earthquakesDownloaded: MutableLiveData<Array<Earthquake>> = MutableLiveData()
    ...
    fun startFetchEarthquakeService() {
        ...
        Log.d(
            TAG,
            "startFetchEarthquakeService : Fetch erthquakes data Service EarthquakeSyncIntentService created."
        )
    }
    ...
    companion object {
        ...
        private val SYNC_INTERVAL_SECONDS =
            TimeUnit.HOURS.toSeconds(SYNC_INTERVAL_HOURS.toLong()).toInt() // 60; //

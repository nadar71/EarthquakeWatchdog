package com.indiewalk.watchdog.earthquake.feat_eqslist.presentation.components.adapter
...
class EarthquakeListAdapter(
    ...
    init {
        ...
        checkPreferences()
        repository = (EarthquakeApp.Companion.getsContext() as EarthquakeApp).repositoryWithDataSource
    }
